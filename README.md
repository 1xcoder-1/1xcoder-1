...
🌐 **Frontend:** Next.js, React, Astro, TypeScript, Tailwind CSS, ShadCN, Framer Motion, GSAP, Zustand, Zod.<br>
⚙️ **Backend:** Node.js, Express, Prisma, Drizzle ORM, REST APIs, Inngest, Socket.IO.<br>
🗄️ **Databases:** PostgreSQL, MongoDB, Redis, Supabase, NeonDB, Firebase.<br>
📱 **Mobile:** React Native, Expo.<br>
🖥️ **Desktop:** Electron.js.<br>
☁️ **Cloud & DevOps:** AWS, Docker, Vercel, Cloudflare, CI/CD, Nginx, Linux.<br>
